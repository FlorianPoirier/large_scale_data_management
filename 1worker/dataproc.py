...
params = { 'd': '0.85', 'docs_in': 'gs://page-rank-bucket/out1worker/pig/pagerank_data_simple' } #modified param from 0.5 to 0.85
...
for i in range(3):
   out = "gs://page-rank-bucket/out1worker/pig/pagerank_data_" + str(i + 1)
   params["docs_out"] = out
   Pig.fs("rmr " + out)
