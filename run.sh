...
## copy pig code
gsutil cp dataproc.py gs://lava-chicken-bucket/
...
gcloud dataproc jobs submit pig --region europe-west1 --cluster cluster-a35a -f gs://lava-chicken-bucket/dataproc.py
